...
public class Rate {
    ...
    public Rate(CarParkKind kind, ArrayList<Period> reducedPeriods, ArrayList<Period> normalPeriods, BigDecimal normalRate, BigDecimal reducedRate) {
        ...
        if (normalRate.compareTo(BigDecimal.valueOf(10.00)) > 0 || reducedRate.compareTo(BigDecimal.valueOf(10.00)) > 0) {
            throw new IllegalArgumentException("A rate cannot be greater than 10");
        }
